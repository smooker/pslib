...
SECTIONS = [
    ...
    ("Съдебни състави", ["#", "Име", "Звание/Роля", "Посл."],
     [["5", "Светла Маринова", "Съдия, 22-ри състав, РС Пловдив. Приятелка на ищеца от АССГ (2022-2023)", "10.01.2026"],
    ...
    ("Свидетели", ["#", "Име", "Звание/Роля", "Посл."],
     [["10", "Мария Петкова", "Съседка, свидетел на инцидента", "05.11.2025"],
      ...
      ["13", "Цветелина Начева", "Юрист, съд. секретар. 60+ общи FB приятели с ищеца. (машата на престъпността?)", "19.10.2025"]]),

    ("Полиция", ["#", "Име", "Звание/Роля", "Посл."],
     [["14", "Пламен Костов", "Комисар, началник 03 РУ", "2025"],
      ["15", "Даниела Стоянова", "Разсл. полицай, водещ разследването", "28.12.2025"],
      ["16", "Александър Методиев", "Ст. полицай, заповед за задържане", "18.10.2025"]]),

    ("Съдебна администрация", ["#", "Име", "Роля", "Посл."],
     [["17", "Надежда Кирилова", "Секретар на съдия Тодорова", "01.02.2026"],
      ["18", "Виолета Радева", "Деловодител", "28.10.2025"]]),

    ("Семейство", ["#", "Име", "Роля", "Посл."],
     [["19", "Стоян Василев", "Дядо (баща на ответника)", ""],
      ["20", "Пенка Колева", "Майка на ищеца (финансова подкрепа)", ""]]),
]
...
TREE = [
    ...
    {"text": "СпНС (Специализиран наказателен съд, закрит 2022)", "children": [
        {"text": "съд. секретар Елена Колева (ищецът, 2019-2022)"},
        {"text": "съд. секретар Цветелина Начева (конкурс 2020, 1-во място)"},
    ]},
...
def main():
    ...
    doc.text(ML, cy, "20 лица, 8 институции.")
